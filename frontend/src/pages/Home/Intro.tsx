...
export default function Intro() {
  return (
    <section
      id="intro"
      className="min-h-[90vh] flex flex-col justify-center px-6 md:px-24 py-20 mt-10 max-w-7xl mx-auto bg-bg text-text"
    >
      <div className="flex flex-col-reverse md:flex-row items-center gap-12">
        {/* 👤 Text Block */}
        <div className="flex-1 text-left">
          <h1 className="text-4xl md:text-5xl font-bold leading-tight tracking-tight font-heading text-primary">
            Hi, I’m Swathy.
          </h1>
          <h2 className="text-2xl font-medium mt-3 font-heading">
            I craft meaningful experiences as a full-stack web developer.
          </h2>
          <p className="text-base md:text-lg mt-6 max-w-xl font-body leading-relaxed">
